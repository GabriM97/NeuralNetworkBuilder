...
@section('content')
    ...
    <form class="form-edit" method="POST" action="{{route("trainings.update", compact("user", "training"))}}">
        @csrf
        @method("PATCH")
        <div class="container col-md-6">
            <h2 class="content-title text-center my-4">Edit Training</h2>
            ...
            <div class="form-group row my-4">
                ...
                <div class="col-md-4 text-md-center">
                    ...
                    <input id="epochs" type="number" class="col-xl-8 form-control float-right @error('epochs') is-invalid @enderror" name="epochs" required value="{{$training->epochs}}" step="1" min="1" max="10000">
                    @error('epochs')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-md-4 text-md-center">
                    ...
                    <input id="batch_size" type="number" class="col-xl-8 form-control float-right @error('batch_size') is-invalid @enderror" name="batch_size" required value="{{$training->batch_size}}" step="1" min="1" max="10000">
                    @error('batch_size')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-md-4 text-md-center">
                    ...
                    <input id="validation_split" type="number" class="col-xl-8 form-control float-right @error('validation_split') is-invalid @enderror" name="validation_split" required value="{{$training->validation_split}}" step="0.01" min="0.0" max="0.99">
